Study summary of Chapter 43 — Falls; the book and the full chapter are the reference.

# Chapter 43 Study: Falls
...
- Falls without injury still matter: fear of falling → reduced mobility/frailty and a key driver of institutionalization (p633).
...
- TUG test: rise from chair, walk **3 meters**, turn, return, sit; a 25-study systematic review found limited predictive value and no validated cut-point (p637).
- Alternatives with good predictive accuracy: Alternate Step Test, Sit-to-Stand Test, Short Physical Performance Battery (each domain scored 0–4, max total **12**) (p637).
- Hospital (UK NICE): automatically assess all patients **65+**, or **50–64 with a risk condition** (e.g., recent stroke) (p637).
...
**3. What fraction of all falls result in minor injury?**
...
**4. What percentage of all hospital admissions in people 65+ are attributable to falls?**
...
**5. By how much does psychoactive medication use (benzodiazepine, antidepressant, antipsychotic) increase fall risk?**

<details><summary>Answer</summary>

A two- to threefold increased risk of falls (p634).
...
**7. What proportion of injurious falls involve extrinsic (environmental) factors?**
...
**8. How much extra injury risk does a fall on stairs carry compared with other falls?**

<details><summary>Answer</summary>

About a twofold increase in injury risk (p637).

</details>

**9. How far does a patient walk during the Timed Up and Go (TUG) test?**
...
**10. Per UK NICE guidance, which hospital patients should automatically undergo a falls risk assessment?**

<details><summary>Answer</summary>

Patients 65 and older, or 50–64 with an underlying risk condition (e.g., recent stroke) (p637).

</details>

**11. On the CaHFRiS RACF fall screen, what MMSE cutoff is a risk item?**

<details><summary>Answer</summary>

MMSE less than 17 (p637).

</details>

**12. Across 64 RCTs, how much did well-designed exercise programs reduce falls in community-dwelling older people?**
...
**13. By how much did expedited first-eye cataract surgery reduce falls in the trial reviewed?**
...
**14. What happened to fall rates in a home-based exercise program for patients recently discharged from hospital?**

<details><summary>Answer</summary>

Falls significantly increased, by 43% (p639).

</details>

**15. By how much did occupational-therapist-delivered home safety interventions reduce falls in high-risk groups?**
