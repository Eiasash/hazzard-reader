Study summary of Chapter 99 — Diabetes Mellitus; the book and the full chapter are the reference.

# Chapter 99 Study: Diabetes Mellitus
...
**Evaluation**
- Comprehensive geriatric assessment (Table 99-4): functional status (ADLs/IADLs), cognition, depression, falls, vision, frailty (p1567).
- Confirm albuminuria on **2 of 3 samples** elevated over **3–6 months**; old terms: microalbuminuria 30–300 mg/g, macroalbuminuria >300 mg/g (being retired) (p1567).
- Annual **10-g monofilament** + **128-Hz tuning fork** testing for neuropathy, starting at diagnosis (p1567).
- Cognitive screening at diagnosis, then **annually** if borderline or **every 2–3 years** if normal (p1568).
...
- **GLP-1 agonists** (e.g., liraglutide, semaglutide [also oral], dulaglutide) — injectable (semaglutide also oral), dose lines range from twice daily to once weekly; source table does not pair each dose line to its named agent (p1577–1578). Cautions: nausea/vomiting, possible pancreatitis, avoid exenatide/lixisenatide if **eGFR <30**.
...
- LTC residents show better observed survival at A1C **8–9%** (p1585).
- End-of-life glucose target: **108–270 mg/dL (6–15 mmol/L)** (p1586).
...
~27% diabetes, ~50% prediabetes (p1562).

</details>

**7. What eGFR and albuminuria values define diabetic kidney disease?**
...
These are the actual 2026 specialist-exam questions and keys sourced to this chapter, reproduced verbatim (English rendering; Hebrew original is the authority) as printed in the chapter's own "2026 exam" section.

**Q6** — sourced to [p. 1574](?chapter=99#p1574). A 72-year-old man diagnosed with type 2 diabetes comes to the clinic for lifestyle counselling. The patient is interested in starting a physical-activity program as recommended by the American Diabetes Association (ADA). Which of the following guidelines is recommended for him?
...
**Q49** — sourced to [p. 1563](?chapter=99#p1563). Which metabolic change is related to aging in people without diabetes?
...
**Q59** — sourced to [p. 1577](?chapter=99#p1577). A 76-year-old woman, independent and active, with type 2 diabetes for 15 years, hypertension and ischemic heart disease. Laboratory tests: eGFR = 18 mL/min/1.73m²; Albumin/Creatinine = 450 mg/gr; HbA1C = 7%; Glucose = 110 mg/dL. She is treated with Metformin at a dose of 2000 mg a day and a DPP-4 inhibitor. What is the recommendation regarding drug treatment for diabetes in this case?
