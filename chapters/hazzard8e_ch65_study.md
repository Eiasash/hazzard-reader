Study summary of Chapter 65 — Major Depression; the book and the full chapter are the reference.

# Chapter 65 Study: Major Depression
...
- Structured assessment: suicidal thoughts, intent, plan, behavior; risk factors (hopelessness, impulsivity, isolation, prior attempts, recent psychiatric discharge, access to means) vs protective factors (reasons for living, supports); document firearm status and an action plan (p1013).
- Assess whether a plan is formulated/rehearsed and whether means (especially firearms) are accessible — removing access lowers immediate risk (p1018).

**Real-world treatment efficacy**
- Even in "gold standard" collaborative care: **<50%** of patients achieve a depression response (≥50% symptom reduction) at 6 months, **<1/3** achieve remission — **two-thirds remain effectively depressed**; between-clinic response rates ranged from **<10%** to **>80%** (p1012).
- Largest geriatric depression treatment trial: **51%** of patients preferred counseling/psychotherapy vs **38%** preferring antidepressants (p1014).
...
**2. What PHQ-9 total score range is generally considered to indicate no or clinically insignificant depressive symptoms, and what range indicates mild/subsyndromal depression?**
...
**4. At what PHQ-9 score range is major depression classified as moderate, and at what range is it classified as severe?**
...
**5. What three screening-tool thresholds trigger the suicide/safety risk factor checklist?**

<details><summary>Answer</summary>

PHQ Question 9 ≥1, MADRS Question 10 ≥3, or QIDS-SR Question 12 ≥1 (p1013).

</details>

**6. In the largest treatment trial of geriatric depression to date, what proportion of patients preferred psychotherapy/counseling versus antidepressant medications?**

<details><summary>Answer</summary>

51% preferred counseling or psychotherapy; 38% preferred antidepressant medications (p1014).

</details>

**7. Even in "gold standard" collaborative care, what fraction of patients achieve a depression response at 6 months, and what fraction remain effectively depressed?**

<details><summary>Answer</summary>

Fewer than half achieve a depression response (≥50% symptom reduction); fewer than a third achieve remission — roughly two-thirds remain effectively depressed (p1012).

</details>

**8. What are the response and remission rates for ECT in treating depression, and how does its effectiveness compare with medications?**

<details><summary>Answer</summary>

Response rate >80%, remission rate >60% — no trial has ever found medications more effective than ECT, and older adults respond even better than younger adults (p1014).
...
**10. Do antidepressant medications show proven benefit for minor/subsyndromal depression, and how well do they generally work for depression in dementia?**
...
**12. Roughly what proportion of nursing home residents are prescribed an antidepressant, and how does that compare with estimated depression prevalence in that population?**

<details><summary>Answer</summary>

Almost half of residents in some nursing home populations are prescribed an antidepressant — far higher than any estimate of actual depression prevalence (p1015).

</details>

**13. What tapering schedule applies to most SSRIs, SNRIs, and mirtazapine, and to tricyclic antidepressants? Which antidepressant is an exception to tapering, and why?**
...
**14. When assessing a patient with suicidal ideation, what two specific factors most raise immediate risk, and what action reduces that risk?**

<details><summary>Answer</summary>

A specified, rehearsed plan and accessible means (especially firearms) most raise immediate risk; removing access to the means (eg, the firearm) decreases immediate risk (p1018).

</details>

**15. Which patients with depression are best suited for geriatric psychiatry subspecialty referral rather than general psychiatry?**

<details><summary>Answer</summary>

Medically complex or cognitively impaired patients, and those whose major depressive episode is related to bipolar disorder or has psychotic features (p1019).
