Study summary of Chapter 52; the book and the full chapter are the reference.

# Chapter 52 Study: Osteoarthritis
...
- ACR classification criteria: age **>50**, **<30 min** morning stiffness, crepitus, bony enlargement/tenderness, normal inflammatory labs, radiographic osteophytes — for classification, not required for diagnosis (p781).
- Synovial fluid WBC **<2000 cells/mm³** is consistent with OA; **>2000 cells/mm³** suggests inflammatory or infectious arthritis (p783).
- OA-related lumbar spinal stenosis: symptoms relieved by *forward* bending (walking uphill, leaning on a shopping cart), worsened by *backward* bending (p782).

**Nonpharmacologic management**
- A physical therapy regimen (strengthening + neuromuscular training) improves symptoms in **two-thirds** of patients with advanced knee OA (p784).
- Cane: use in the hand **opposite** the affected hip/knee; fit to the level of the greater trochanter; elbow bend ~**15°–20°** when walking (p787).
- Weight-loss target: **>5%** loss achieved within a **20-week** period (p786).
...
- Total joint replacement: **20%–30%** of patients not satisfied post-op; max improvement at **3–6 months**, plateauing by **9–12 months**; implants typically last **≥15 years** (p789).
...
**9. Which hand should hold a cane, and what elbow angle is targeted?**

<details><summary>Answer</summary>

The hand opposite the affected hip or knee; the elbow should bend approximately 15 to 20 degrees when walking with the cane (p787).

</details>

**10. What weight-loss target and timeframe are recommended for OA management?**

<details><summary>Answer</summary>

More than 5% weight loss achieved within a 20-week period (p786).

</details>

**11. Which OA drug therapies does the ACR/AF guideline recommend against, and why?**
...
**14. How many intra-articular glucocorticoid injections are recommended within a 6-month period, and roughly how long does the pain relief last?**

<details><summary>Answer</summary>

No more than 3 injections within a 6-month period; pain relief typically lasts up to 2 months (p789).

</details>

**15. What is the 10-year failure rate of high tibial osteotomy, and what is the surgical procedure of choice for first CMC (thumb base) OA?**

<details><summary>Answer</summary>

Approximately 25% failure rate at 10 years for high tibial osteotomy; trapeziectomy is the procedure of choice for first CMC joint OA (p789–790).
